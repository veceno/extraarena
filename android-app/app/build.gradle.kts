...
val legalOfferUrl = propOrEnv("EXTRAARENA_OFFER_URL", "https://clumsily-deft-guan.cloudpub.ru/legal/offer")
val legalPrivacyUrl = propOrEnv("EXTRAARENA_PRIVACY_URL", "https://clumsily-deft-guan.cloudpub.ru/legal/privacy")
val legalRefundUrl = propOrEnv("EXTRAARENA_REFUND_URL", "https://clumsily-deft-guan.cloudpub.ru/legal/refunds")
