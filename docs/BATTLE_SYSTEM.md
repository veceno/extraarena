...
| `WARRIOR` | Существо. Выставляется на доску, атакует | `player.board` (макс. 7) |
...
### Воин (WARRIOR)
1. Проверка лимита доски: максимум **7** юнитов
...
| `battlecry_draw_card` | Тянет карту из колоды (с учётом лимита руки 4) |
