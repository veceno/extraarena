...
- [ ] If using `extraarena.space`, `docs/EXTRAARENA_SPACE_CLOUDFLARE.md` has been followed: tunnel DNS, Worker route, `WEBAPP_URL`, `EXTRA_SHOP_URL`, `CORS_ALLOWED_ORIGINS`, and Telegram BotFather domain all match the rollout plan.
