...
TIER_REWARDS_COUNT = {
    ...
    5: {  # T5 (Божественный)
        ...
        "cards": (7, 8),         # Карт: 7–8
        # Дополнительно: низкий шанс бонусных гемов и/или осколков лимиток
        "gems_chance": 0.10,     # 10% шанс на бонусные гемы
        "gems_amount": (10, 50), # Количество гемов
        "limited_shards_chance": 0.05,  # 5% шанс на осколки лимиток
        "limited_shards_amount": (1, 5),  # Количество осколков
    },
}
...
UNI_CARD_ID = None  # Нужно установить после создания карты Юни в БД
